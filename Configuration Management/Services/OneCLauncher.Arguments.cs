...
public static partial class OneCLauncher
{
    ...
    /// значение закрывает само себя и дописывает в строку произвольный параметр: каталог вида
    /// <c>C:\Base";Usr="admin</c> уходит в CREATEINFOBASE как два параметра вместо одного,
    /// а имя базы с кавычкой не даёт создать базу вовсе.
    /// </para>
    /// </summary>
