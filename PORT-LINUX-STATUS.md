...
### `14b7b43` Синхронные диалоги вешали интерфейс
...
Из шестнадцати Avalonia-окон в Linux-сборке достижимы только два:
...
`_port/` выведен из-под контроля версий (`7296dd1`). Каталог держит логи
запуска и скриншоты приложения, и при появлении форка на GitHub всё это ушло
бы в публичную историю вместе с именами баз, серверов и путями подключения.
